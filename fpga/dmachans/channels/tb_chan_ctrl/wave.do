...
add wave -noupdate -expand -group chan_ctrl /tb/chan_ctrl/clk
add wave -noupdate -expand -group chan_ctrl /tb/chan_ctrl/rst_n
...
WaveRestoreCursors {{Cursor 1} {2757 ns} 0}
